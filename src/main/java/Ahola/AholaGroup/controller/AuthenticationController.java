...
public class AuthenticationController {
    ...
    public AppResponse<String> resetPassword(@RequestBody AuthenticationRequest authenticationRequest){
        return authenticationService.resetPassword(authenticationRequest);
    }
}
